...
public class SysUserServiceImpl extends ServiceImpl<SysUserDao, SysUserEntity> implements SysUserService {
     ...
     */
    @Override
    public String selectUserRoleGroup(SysUserEntity user) {
        ...
        for (Long roldId : roldList) {
            SysRoleEntity roleEntity = sysRoleService.getById(roldId);
            list.add(roleEntity);
        }
     ...
     */
    @Override
    public String selectUserPostGroup(SysUserEntity user) {
        return null;
    }
